// Modified for Chrome Extension content script (non-module) usage
(function() {
let wasm;
...
async function init(input) {
    if (typeof input === 'undefined') {
        throw new Error('WASM URL must be provided explicitly in content script context');
    }
    const imports = {};
    imports.wbg = {};
...
// Expose to global scope for content script usage
window.__jieba_wasm = {
  init: init,
  cut: cut,
  cut_all: cut_all,
  cut_for_search: cut_for_search,
  tokenize: tokenize,
  add_word: add_word
};
})();
